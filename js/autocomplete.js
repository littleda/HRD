...
(function () {
    ...
    var webkit = /webkit/.test(ua), webkit4 = /webkit\/4/.test(ua), gecko = !webkit && /gecko/.test(ua), ff2 = !webkit && /firefox\/2/.test(ua), ff3 = !webkit && /firefox\/3/.test(ua), msie = /msie/.test(ua), msie6 = /msie 6/.test(ua), msie7 = /msie 7/.test(ua), msie8 = /msie 8/.test(ua), backCompat = document.compatMode == "BackCompat", loaded = 0, sw = 0, sn, $$ = 0, PX = "px", Event = new Object(), g_bw = 1;
    var empty = function () {
    }, getStyle = function (e) {
    ...
    Ajax.Updater = Class.create({_complete: false, initialize: function (options) {
            this.options = {contentType: "application/x-www-form-urlencoded", encoding: "UTF-8"};
    ...
    Object.extend(ac, {unlock: function (n) {
        ...
        }, inst: new Array(), name: "", key: "", updateViews: function () {
            for (var i = 0; i < ac.inst.length; i++) {
                ac.inst[i].image.position()
            }
        }});
    var NSImage = Class.create({initialize: function (o) {
    ...
    Object.extend(NSImage, {count: 0});
    var NSList = Class.create({initialize: function (object, withFrame) {
            NSList.count++;
            ...
            var l = p[0], d = t.offsetWidth - w, a = this.o.options.align, ls = this.e.style;
            ...
            var items = new Array(), ls = this.e.childNodes;
            ...
            var ls = this.e.childNodes, i = 0, lt;
            for (var j = 0; j < ls.length; j++) {
                var x = ls[j];
                if (ac.I(x)) {
                    lt = x;
    ...
    Object.extend(NSList, {count: 0});
    ac.prototype = {$c: 0, init: 0, T: 0, i: -1, d: 1, custom_uri: "", initialize: function (t, f, options) {
            ...
            this.options = {width: "auto", delay: 0.4, delimChars: ",", size: 10, select_first: 1, align: "auto"};
            Object.extend(this.options, options || {})
        }, r: function () {
            ...
            var u = this.L.e, h = this.options.size * m.offsetHeight, mt = m.offsetTop;
            if (ff2) {
                mt += g_bw
            }
            if (msie8) {
            ...
            if (this.isON) {
                ...
                this.i = -1;
                this.image.go();
                this.latest = new Ajax.Updater({onComplete: this.d.bind(this)});
            ...
            this.isON = 1;
            var w = this.L2.autoWidth(), h = "auto";
            this.i = -1;
