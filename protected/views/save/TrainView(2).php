...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'urlExpression' => 'Yii::app()->createUrl("/save/InsertUpdate", array("id" =>$data->ID,"letDef"=>$data->letterDef,"No"=>$data->No ))',
            'htmlOptions' => array(
                'width' => '2%',
                'align' => 'center'
            )
        ...
        array(
            ...
            'urlExpression' => 'Yii::app()->createUrl("/save/delete",array("id" => $data->ID,"letDef"=>$data->letterDef,"No"=>$data->No))',
            'htmlOptions' => array(
                'width' => '2%',
                'align' => 'center',
